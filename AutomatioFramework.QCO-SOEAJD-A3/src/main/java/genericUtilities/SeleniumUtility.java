...
public class SeleniumUtility {
	 ...
	 * @param value
	 */
	public void handleDropeDown(WebElement element, String value)
	{
	...
	/**
	 * This method will scroll until a perticular web element
	 * @param driver
	 * @param element
	 */
	...
	public String captureScreenShot(WebDriver driver, String ScreenshotName) throws IOException
	{
		...
		return dst.getAbsolutePath();//user in extent reports
	}

	/**
	 * This method will select option from dropdown by its value
	 * @param element
	 * @param value
	 */
